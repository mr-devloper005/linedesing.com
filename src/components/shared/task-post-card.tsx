  ...
  if (experience.key === "linedesing") {
    if (variant === "image") {
      return (
        <Link
          href={href}
          className="group relative mb-6 block break-inside-avoid overflow-hidden rounded-2xl bg-white transition-all duration-500 hover:shadow-2xl"
        >
          {/* Angled corner accent */}
          <div className="absolute -right-8 -top-8 h-24 w-24 rotate-45 bg-gradient-to-br from-pink-500 to-purple-600 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
          ...
          <div className="relative aspect-[4/5] overflow-hidden rounded-2xl bg-slate-100">
            ...
            <div className="absolute bottom-4 left-4">
              <span className="inline-flex items-center gap-1.5 rounded-full bg-white/95 px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-slate-950 shadow-lg backdrop-blur-sm">
          ...
          <div className="relative border-l-4 border-transparent p-5 transition-colors duration-300 group-hover:border-pink-500">
            <h3 className="text-lg font-bold leading-snug text-slate-950 line-clamp-2">{post.title}</h3>
            <p className="mt-2 text-sm leading-relaxed text-slate-500 line-clamp-2">{excerpt}</p>
            
            {/* Read more indicator */}
            <div className="mt-3 flex items-center gap-2 text-xs font-semibold text-pink-600 opacity-0 transition-all duration-300 group-hover:opacity-100">
    ...
    if (variant === "profile") {
      return (
        <Link
          href={href}
          className="group relative flex h-full flex-col overflow-hidden rounded-2xl bg-white transition-all duration-500 hover:shadow-2xl"
        >
          {/* Bottom angled accent */}
          <div className="absolute -bottom-8 -right-8 h-24 w-24 rotate-45 bg-gradient-to-br from-purple-600 to-pink-500 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
          ...
          <div className="relative aspect-[16/10] overflow-hidden bg-slate-100">
            ...
            <div className="absolute right-3 top-3 translate-y-2 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-white/95 shadow-lg backdrop-blur-sm">
          ...
          <div className="relative flex-1 border-l-4 border-transparent px-5 pb-5 pt-0 transition-colors duration-300 group-hover:border-purple-500">
            <div className="-mt-8 flex items-end gap-3">
              <div className="relative h-16 w-16 overflow-hidden rounded-xl border-4 border-white bg-white shadow-xl">
            ...
            <div className="mt-3">
              <h3 className="text-lg font-bold leading-snug text-slate-950 line-clamp-1">{post.title}</h3>
              <p className="mt-1.5 text-sm leading-relaxed text-slate-500 line-clamp-2">{excerpt}</p>
            </div>
            
            {/* View profile link */}
            <div className="mt-4 flex items-center gap-2 text-xs font-semibold text-purple-600 opacity-0 transition-all duration-300 group-hover:opacity-100">
